...
const GENRES = [
  ...
  { value: 'CIENCIAS-SOCIAIS', label: 'Ciências Sociais' },
  ...
  { value: 'EPISTOLAR', label: 'Romance Epistolar' },
  { value: 'ESPIRITUALIDADE', label: 'Espiritualidade' },
  { value: 'ESPORTES', label: 'Esportes' },
  { value: 'FANTASIA', label: 'Fantasia' },
  { value: 'FICAO-HISTORICA', label: 'Ficção Histórica' },
  ...
  { value: 'GUIA-VIAGEM', label: 'Guia de Viagem' },
  ...
  { value: 'LITERATURA-INFANTOJUVENIL', label: 'Literatura Infantojuvenil' },
  { value: 'MANGA', label: 'Mangá' },
  { value: 'MARKETING', label: 'Marketing' },
  { value: 'MATEMATICA', label: 'Matemática' },
  { value: 'MEDICINA', label: 'Medicina' },
  { value: 'MEIO-AMBIENTE', label: 'Meio Ambiente' },
  { value: 'MEMORIAS', label: 'Memórias / Autobiografia' },
  ...
  { value: 'POS-APOCALIPTICO', label: 'Pós-Apocalíptico' },
  { value: 'PSICOLOGIA', label: 'Psicologia' },
  { value: 'QUADRINHOS', label: 'Quadrinhos / HQ' },
  { value: 'QUIMICA', label: 'Química' },
  { value: 'REALISMO-MAGICO', label: 'Realismo Mágico' },
  { value: 'RELIGIAO', label: 'Religião' },
  { value: 'ROMANCE', label: 'Romance' },
  { value: 'SAUDE', label: 'Saúde e Bem-Estar' },
  { value: 'SATIRIA', label: 'Sátira' },
  { value: 'SOCIOLOGIA', label: 'Sociologia' },
  { value: 'SUSPENSE', label: 'Suspense / Thriller' },
  { value: 'TECNOLOGIA', label: 'Tecnologia' },
  { value: 'TEATRO', label: 'Teatro' },
  { value: 'TERROR-PSICOLOGICO', label: 'Terror Psicológico' },
