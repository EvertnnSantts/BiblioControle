...
router.get('/', authenticate, requireAdmin, loanController.getAllLoans);

// GET /api/loans/active - Listar ativos
router.get('/active', authenticate, requireAdmin, loanController.getActiveLoans);

// GET /api/loans/stats - Estatísticas
router.get('/stats', authenticate, requireAdmin, loanController.getStats);

// GET /api/loans/turmas - Listar turmas
router.get('/turmas', authenticate, requireAdmin, loanController.getTurmas);
...
router.post('/:id/return', authenticate, requireAdmin, loanController.returnLoan);
